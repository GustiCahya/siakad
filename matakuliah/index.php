...
// Mengambil data matakuliah dari database
...
<html>
<head>
    <title>Siakad - Daftar Matakuliah</title>
...
<body>
    <div class="container">
        ...
        <h1 class="mt-4">Siakad - Daftar Matakuliah</h1>

        <a href="create.php" class="btn btn-primary mb-4 mt-2">Tambah Mata Kuliah</a>
